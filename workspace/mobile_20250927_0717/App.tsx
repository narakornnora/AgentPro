    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View style={styles.header}>
          <Text style={styles.appTitle}>สร้าง mobile app เลียนแบบ IG หรือ intagram</Text>
          <Text style={styles.appSubtitle}>สร้าง mobile app เลียนแบบ IG หรือ intagram</Text>
        </View>
