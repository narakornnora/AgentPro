    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View style={styles.header}>
          <Text style={styles.appTitle}>สร้าง mobile app ร้านกาแฟ สำหรับ order online ต้องมี หน้าเมนู หน้าตะกร้า หน้า payment ใช้ React Native</Text>
          <Text style={styles.appSubtitle}>สร้าง mobile app ร้านกาแฟ สำหรับ order online ต้องมี หน้าเมนู หน้าตะกร้า หน้า payment ใช้ React Native</Text>
        </View>
